...
def main() -> None:
    parser = argparse.ArgumentParser(description="Batch generate .splattie demos (head or body)")
    parser.add_argument("--asset-type", choices=["head", "body"], default="head")
    ...
    print(f"Asset type: {args.asset_type} | widget version: {widget_version}\n")
